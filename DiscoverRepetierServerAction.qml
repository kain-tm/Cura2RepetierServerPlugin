...
Cura.MachineAction
{
    ...
    {
        anchors.fill: parent;
        id: discoverRepetierServerAction
        ...
        Label
        {
            id: pageTitle
            width: parent.width
            text: catalog.i18nc("@title", "Connect to Repetier-Server")
        ...
        Label
        {
            ...
            width: parent.width
            wrapMode: Text.WordWrap
            text: catalog.i18nc("@label", "Select your Repetier-Server instance from the list below:")
        }
        ...
        Row
        {
            ...
            Column
            {
                ...
                {
                    visible: base.selectedInstance != null
                    text: catalog.i18nc("@label", "Please enter the API key to access Repetier-Server above. You can get the Repetier-Server API key through the Repetier-Server web page.")
                ...
                Column
                {
                    ...
                    CheckBox
                    {
                        ...
                        checked: Cura.ContainerManager.getContainerMetaDataEntry(Cura.MachineManager.activeMachineId, "repetier_auto_print") != "false"
                        onClicked:
                        {
                    ...
                    CheckBox
                    {
                        ...
                        checked: Cura.ContainerManager.getContainerMetaDataEntry(Cura.MachineManager.activeMachineId, "repetier_show_camera") == "true"
                        onClicked:
                        {
                ...
                Label
                {
                    text: catalog.i18nc("@label", "Note: Printing UltiGCode using Repetier-Server does not work. Please switch your Gcode flavour to RepRap (Marlin/Sprinter).")
                    width: parent.width - UM.Theme.getSize("default_margin").width
                    wrapMode: Text.WordWrap
    ...
    UM.Dialog
    {
        ...
        title: catalog.i18nc("@title:window", "Manually added Repetier-Server instance")
