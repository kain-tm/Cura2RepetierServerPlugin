...
from . import RepetierServerOutputDevice
...
##      This plugin handles the connection detection & creation of output device objects for Repetier-Server-connected printers.
...
class RepetierServerOutputDevicePlugin(OutputDevicePlugin):
    def __init__(self):
        ...
        self._name_regex = re.compile("Repetier-Server instance (\".*\"\.|on )(.*)\.")
    ...
    def addInstance(self, name, address, port, properties):
        instance = RepetierServerOutputDevice.RepetierServerOutputDevice(name, address, port, properties)
